...
- Действия по событиям чата — именованные автоматизации (уведомление, HTTP-запрос, bash-команда, скрипт по расписанию), срабатывающие по событиям жизненного цикла чата, с переменными данных события в теле
