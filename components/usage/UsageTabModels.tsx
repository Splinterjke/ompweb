...
export function UsageTabModels({ overall, byModel }: Props) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24, padding: "4px 0" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 14 }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <span style={{ fontSize: "calc(11px * var(--ui-font-scale-sm, 1))", fontWeight: 600, color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.05em" }}>
        ...
        >
          ...
          <div>
            <div style={{ fontFamily: "var(--font-mono)", fontSize: "calc(20px * var(--ui-font-scale-lg, 1))", fontWeight: 700, color: "var(--text)" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ fontSize: "calc(13px * var(--ui-font-scale-lg, 1))", fontWeight: 700, color: "var(--text)" }}>
              ...
              return (
                ...
                >
                  ...
                  <td style={{ padding: "10px", textAlign: "right", fontFamily: "var(--font-mono)" }}>
                    ...
                    {m.failedRequests > 0 && (
                      <span style={{ color: "var(--status-error)", fontSize: "calc(10px * var(--ui-font-scale-sm, 1))", marginLeft: 4 }}>
