              ...
              >
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    <span style={{ fontSize: "calc(13px * var(--ui-font-scale-lg, 1))", fontWeight: 700, color: "var(--text)", textTransform: "capitalize" }}>
                      {isSubagent ? (t("usage.subagents") || "Subagents") : (t("usage.mainAgent") || "Main agent")}
                    </span>
                  </div>
                  <span style={{ fontFamily: "var(--font-mono)", fontSize: "calc(11px * var(--ui-font-scale-sm, 1))", color: "var(--text-dim)" }}>
                    {ag.totalRequests} requests
                  </span>
                </div>

                <div style={{ display: "flex", alignItems: "baseline", gap: 8 }}>
                  <span style={{ fontFamily: "var(--font-mono)", fontSize: "calc(22px * var(--ui-font-scale-lg, 1))", fontWeight: 700, color: "var(--text)" }}>
                    {formatTokenCount(totalTokens, locale)}
                  </span>
                  <span style={{ fontSize: "calc(12px * var(--ui-font-scale-lg, 1))", color: "var(--text-muted)" }}>Tokens</span>
                </div>

                <div style={{ display: "flex", justifyContent: "space-between", fontSize: "calc(11px * var(--ui-font-scale-sm, 1))", color: "var(--text-dim)", borderTop: "1px solid var(--border)", paddingTop: 8, marginTop: 4 }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: "calc(13px * var(--ui-font-scale-lg, 1))", fontWeight: 700, color: "var(--text)" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 16, flexShrink: 0 }}>
                    <div style={{ textAlign: "right" }}>
                      <div style={{ fontFamily: "var(--font-mono)", fontSize: "calc(13px * var(--ui-font-scale-lg, 1))", fontWeight: 700, color: "var(--text)" }}>
                        {formatTokenCount(totalTokens, locale)}
                      </div>
                      <div style={{ fontSize: "calc(10px * var(--ui-font-scale-sm, 1))", color: "var(--text-dim)" }}>
