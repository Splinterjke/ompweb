      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              <DialogTitle style={{ margin: 0, fontSize: "calc(16px * var(--ui-font-scale-lg, 1))", fontWeight: 700 }}>
                Usage & Logs Analytics Dashboard
              </DialogTitle>
              <div style={{ fontSize: "calc(11px * var(--ui-font-scale-sm, 1))", color: "var(--text-dim)", marginTop: 2, display: "flex", alignItems: "center", gap: 6 }}>
