    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16, padding: "4px 0" }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: "calc(11px * var(--ui-font-scale-sm, 1))", color: "var(--text-dim)" }}>
      ...
      >
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "calc(12px * var(--ui-font-scale-lg, 1))" }}>
            <thead>
              <tr
                style={{
              ...
              {logs.length === 0 ? (
                ...
                logs.map((log) => {
                  ...
                  return (
                    ...
                    >
                      {/* 时间 */}
                      <td style={{ padding: "10px 14px", fontFamily: "var(--font-mono)", fontSize: "calc(11px * var(--ui-font-scale-sm, 1))", color: "var(--text-muted)", whiteSpace: "nowrap" }}>
                      ...
                      {/* 提供方 */}
                      <td style={{ padding: "10px 14px", color: "var(--text-muted)", whiteSpace: "nowrap", fontSize: "calc(11px * var(--ui-font-scale-sm, 1))" }}>
                        {log.provider}
                      </td>
          ...
          <DialogContent ariaLabel="Request details" style={{ width: 640, maxWidth: "min(92vw, 640px)", padding: 22 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16, marginTop: 14 }}>
              ...
              {detailEntry.errorMessage && (
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 6, color: "var(--status-error)", fontSize: "calc(12px * var(--ui-font-scale-lg, 1))", fontWeight: 700 }}>
                    <XCircle size={14} />
              ...
              >
                <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  <span style={{ color: "var(--text-dim)", fontSize: "calc(11px * var(--ui-font-scale-sm, 1))" }}>Model:</span>
                  <span style={{ fontFamily: "var(--font-mono)", fontWeight: 600, color: "var(--text)" }}>
                    {detailEntry.model}
                  </span>
                </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  <span style={{ color: "var(--text-dim)", fontSize: "calc(11px * var(--ui-font-scale-sm, 1))" }}>Provider:</span>
                  <span style={{ color: "var(--text)" }}>{detailEntry.provider}</span>
                </div>

                <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  <span style={{ color: "var(--text-dim)", fontSize: "calc(11px * var(--ui-font-scale-sm, 1))" }}>Timestamp:</span>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  <span style={{ color: "var(--text-dim)", fontSize: "calc(11px * var(--ui-font-scale-sm, 1))" }}>Status:</span>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  <span style={{ color: "var(--text-dim)", fontSize: "calc(11px * var(--ui-font-scale-sm, 1))" }}>Duration:</span>
                  <span style={{ fontFamily: "var(--font-mono)", color: "var(--text)" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
                  <span style={{ color: "var(--text-dim)", fontSize: "calc(11px * var(--ui-font-scale-sm, 1))" }}>Estimated cost:</span>
                  <span style={{ fontFamily: "var(--font-mono)", color: "var(--text)" }}>
              ...
              >
                <span style={{ fontSize: "calc(11px * var(--ui-font-scale-sm, 1))", fontWeight: 600, color: "var(--text-muted)", textTransform: "uppercase" }}>
                  Token breakdown
                </span>
                <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8, textAlign: "center" }}>
                  <div>
                    <div style={{ fontSize: "calc(10px * var(--ui-font-scale-sm, 1))", color: "var(--text-dim)" }}>Input</div>
                    <div style={{ fontFamily: "var(--font-mono)", fontWeight: 600, color: "var(--text)" }}>
                      {detailEntry.inputTokens.toLocaleString()}
                    </div>
                  </div>
                  <div>
                    <div style={{ fontSize: "calc(10px * var(--ui-font-scale-sm, 1))", color: "var(--text-dim)" }}>Output</div>
                    <div style={{ fontFamily: "var(--font-mono)", fontWeight: 600, color: "var(--text)" }}>
                      {detailEntry.outputTokens.toLocaleString()}
                    </div>
                  </div>
                  <div>
                    <div style={{ fontSize: "calc(10px * var(--ui-font-scale-sm, 1))", color: "var(--text-dim)" }}>Cache read</div>
                    <div style={{ fontFamily: "var(--font-mono)", fontWeight: 600, color: "var(--text)" }}>
                      {detailEntry.cacheReadTokens.toLocaleString()}
                    </div>
                  </div>
                  <div>
                    <div style={{ fontSize: "calc(10px * var(--ui-font-scale-sm, 1))", color: "var(--text-dim)" }}>Total</div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6, fontSize: "calc(11px * var(--ui-font-scale-sm, 1))" }}>
