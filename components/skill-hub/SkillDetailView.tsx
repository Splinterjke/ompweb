    ...
    <div className={css.panel}>
      <div className={css.detailHead}>
        ...
        <span className={css.detailName} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
          {detail.name}
          {isDisplayNameDistinct(detail.name, detail.displayName) ? <span className={css.displayName} style={{ fontSize: "calc(13px * var(--ui-font-scale-lg, 1))", marginLeft: 0 }}>{detail.displayName}</span> : null}
        ...
        <div className={css.diagRow} style={{ margin: '8px 0', border: '1px solid var(--accent, #e5534b)' }}>
          ...
          {detail.fixable === true && detail.path && onFixDiagnostic ? (
            <button
              ...
              style={{ flex: 'none', alignSelf: 'center', fontSize: "calc(12px * var(--ui-font-scale-lg, 1))", padding: '4px 10px' }}
            >
