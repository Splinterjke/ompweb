...
export const zh = {
  ...
  'row.duplicate': '重名',
  'row.duplicateHint': '存在重名技能，优先级最高的版本已标记',
  'row.priority': '优先',
  'row.copy': '复制',
  ...
  'form.root': '目标目录',
  'root.user-agents': '~/.agents/skills（全局标准推荐）',
  'root.user-omp': '~/.omp/agent/skills（omp 全局）',
  'root.user-dsh': '~/.dsh/skills（dsh 全局）',
  'root.user-codex': '~/.codex/skills（codex 全局）',
  'root.project-agents': './.agents/skills（当前项目）',
  'root.project-omp': './.omp/skills（当前项目）',
  'src.user-codex': 'Codex（全局）',
  'src.user-agents': 'Agents（全局）',
  'src.user-omp': 'OMP（全局）',
  'src.user-dsh': 'DSH（全局）',
  'form.submit': '创建',
  'form.cancel': '取消',
...
export const en: Record<HubKey, string> = {
  ...
  'row.duplicateHint': 'Skills with duplicate names; priority one is tagged',
  ...
  'root.user-agents': '~/.agents/skills (standard)',
  'root.user-omp': '~/.omp/agent/skills (omp global)',
  'root.user-dsh': '~/.dsh/skills (dsh global)',
  'root.user-codex': '~/.codex/skills (codex global)',
  'root.project-agents': './.agents/skills (this project)',
  'root.project-omp': './.omp/skills (this project)',
  'src.user-codex': 'Codex (global)',
  'src.user-agents': 'Agents (global)',
  'src.user-omp': 'OMP (global)',
  'src.user-dsh': 'DSH (global)',
  'form.submit': 'Create',
  'form.cancel': 'Cancel',
  'form.busy': 'Creating…',
