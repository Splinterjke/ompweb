        ...
        <div style={{ padding: "12px 14px" }}>
          {planContent && (
            ...
            >
              ...
              {planTruncated && (
                <div style={{ marginTop: 8, fontSize: "calc(11px * var(--ui-font-scale-sm, 1))", color: "var(--text-dim)" }}>
          ...
          {hasTasks ? (
            ...
            <div style={{ padding: "8px 0", color: "var(--text-muted)", fontSize: "calc(13px * var(--ui-font-scale-lg, 1))", textAlign: "center" }}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <h3 style={{ margin: 0, fontSize: "calc(15px * var(--ui-font-scale-lg, 1))", fontWeight: 700, color: "var(--text)" }}>
            ...
            <p style={{ margin: 0, fontSize: "calc(13px * var(--ui-font-scale-lg, 1))", color: "var(--text-muted)", lineHeight: 1.5 }}>
              {t("plan.critiqueBody")}
            </p>
