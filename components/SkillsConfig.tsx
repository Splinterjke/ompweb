  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
        ...
        />
        {saveError && (
          <span style={{ fontSize: "calc(12px * var(--ui-font-scale-lg, 1))", color: "var(--status-error)", flexShrink: 0 }}>
            {saveError}
          </span>
        )}
      </div>
      ...
      {skill.install?.skillsShUrl && (
        <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
          <span
            style={{ fontSize: "calc(12px * var(--ui-font-scale-lg, 1))", color: "var(--text-muted)", fontWeight: 500 }}
          >
      ...
      {skill.install && (
        <div style={{ display: "flex", flexDirection: "column", gap: 7 }}>
          ...
          {updateError && (
            <span style={{ fontSize: "calc(12px * var(--ui-font-scale-lg, 1))", color: "var(--status-error)" }}>{updateError}</span>
          )}
        </div>
      )}
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
        ...
        <span
          style={{ fontSize: "calc(14px * var(--ui-font-scale-lg, 1))", color: "var(--text-muted)", lineHeight: 1.6 }}
        >
          {skill.description}
        </span>
      </div>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      >
        ...
        {/* Errors */}
        {searchError && (
          <div style={{ fontSize: "calc(12px * var(--ui-font-scale-lg, 1))", color: "var(--status-error)" }}>{searchError}</div>
        )}
        {installError && (
          <div
            style={{ fontSize: "calc(12px * var(--ui-font-scale-lg, 1))", color: "var(--status-error)", wordBreak: "break-word" }}
          >
            {installError}
          </div>
        )}
      ...
      {results.length > 0 ? (
        ...
        !searching && (
          <div
            style={{ fontSize: "calc(13px * var(--ui-font-scale-lg, 1))", color: "var(--text-dim)", lineHeight: 1.8 }}
          >
            {(() => {
        ...
        >
          <div style={{ display: "flex", alignItems: "baseline", gap: 10 }}>
            <span
              ...
              style={{ fontSize: "calc(15px * var(--ui-font-scale-lg, 1))", fontWeight: 700, color: "var(--text)" }}
            >
                      ...
                      <div key={grpLabel} style={{ marginBottom: 6 }}>
                        ...
                        {[...grpSkills.filter((skill) => !skill.disableModelInvocation), ...grpSkills.filter((skill) => skill.disableModelInvocation)].map((skill, index, orderedSkills) => {
                          ...
                          return (
                            ...
                            {firstDormant && (
                              <div style={{ marginTop: 6, padding: "6px 8px 3px", borderTop: "1px solid var(--border)", fontSize: "calc(10px * var(--ui-font-scale-sm, 1))", fontWeight: 600, color: "var(--text-dim)", textTransform: "uppercase", letterSpacing: "0.06em" }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            {(() => {
              ...
              return (
                <span style={{ fontSize: "calc(12px * var(--ui-font-scale-lg, 1))", color: "var(--status-warning)" }}>
