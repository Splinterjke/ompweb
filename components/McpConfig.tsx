    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 14, marginTop: 8 }}>
      ...
      {builtinPresets.length > 0 && (
        ...
        >
          ...
          >
            ...
            <strong style={{ fontSize: 13, color: "var(--text)" }}>{t("mcpConfig.builtinServers") || "Built-in MCP Extensions"}</strong>
            <span
              style={{
                fontSize: 10,
                padding: "2px 7px",
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 5 }}>
                    ...
                    <span style={{ fontSize: 10, color: "var(--text-dim)", alignSelf: "center", marginLeft: 4 }}>+ 8 more advanced orchestration tools</span>
                  </div>
                </div>
              );
            })}
            ...
            {editorMode === "form" ? (
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", gap: 10 }}>
                  <div>
                    <label style={{ display: "block", color: "var(--text-muted)", fontSize: 11, marginBottom: 4 }}>Transport</label>
                    <select
                      value={formType}
                  ...
                  {formType === "stdio" ? (
                    <div>
                      <label style={{ display: "block", color: "var(--text-muted)", fontSize: 11, marginBottom: 4 }}>Command</label>
                      <input
                        value={formCommand}
                    ...
                    <div>
                      <label style={{ display: "block", color: "var(--text-muted)", fontSize: 11, marginBottom: 4 }}>Remote URL (Endpoint)</label>
                      <input
                        value={formUrl}
                ...
                {formType === "stdio" && (
                  <div>
                    <label style={{ display: "block", color: "var(--text-muted)", fontSize: 11, marginBottom: 4 }}>Arguments</label>
                    <input
                      value={formArgs}
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 11, color: "var(--text-dim)" }}>({displayedServers.length})</span>
