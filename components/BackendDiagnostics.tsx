    ...
    <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      {diag && (() => {
        ...
        const issues = [
          ...
          hostDown || hostCrash ? { key: "host", title: "Rust Host daemon abnormal", detail: "Host is not ready or has crashed; repair will clean up orphan processes and restart.", action: <button type="button" onClick={() => void repairHost()} disabled={actionBusy} style={{ padding: "5px 12px", borderRadius: "var(--radius-control)", background: "var(--accent)", color: "var(--on-accent)", border: "none", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>{t("diagnostics.repair")}</button> } : null,
          orphan ? { key: "orphan", title: `${diag.rpc.orphanRustHosts} orphan Host processes detected`, detail: "Orphan processes may hold session locks or PTYs.", action: <button type="button" onClick={() => void repairHost()} disabled={actionBusy} style={{ padding: "5px 12px", borderRadius: "var(--radius-control)", background: "var(--accent)", color: "var(--on-accent)", border: "none", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>Clean up orphans</button> } : null,
          rpcFailed ? { key: "rpc", title: `${diag.rpc.recentFailures?.length} recent RPC session failures`, detail: "May be caused by abnormal termination of model child processes; restarting RPC restores all dropped channels.", action: <button type="button" onClick={() => void restartRpc()} disabled={restarting || actionBusy} style={{ padding: "5px 12px", borderRadius: "var(--radius-control)", background: "var(--bg-subtle)", color: "var(--text)", border: "1px solid var(--border)", fontSize: 12, fontWeight: 600, cursor: "pointer" }}>{t("diagnostics.restartRpc")}</button> } : null,
      ...
      >
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: "var(--text)" }}>Web UI Client</span>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: "var(--text)" }}>Next.js Server</span>
              <span style={{ width: 6, height: 6, borderRadius: "50%", background: "var(--status-success)" }} />
            </div>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: "var(--text)" }}>Rust Host Daemon</span>
              <span
                style={{
                  width: 6,
                  height: 6,
          ...
          >
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: "var(--text)" }}>OMP Engine Process</span>
              <span
                style={{
                  width: 6,
                  height: 6,
