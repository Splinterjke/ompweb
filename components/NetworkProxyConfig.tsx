...
export function NetworkProxyConfig() {
  ...
  return (
    <div style={{ marginTop: 12, paddingTop: 14, borderTop: "1px solid var(--border)" }}>
      <h4 style={{ fontSize: "calc(13px * var(--ui-font-scale-lg, 1))", fontWeight: 600, margin: "0 0 4px", color: "var(--text)", display: "flex", alignItems: "center", gap: 6 }}>
        <Network size={13} aria-hidden="true" />
        {t("proxy.title")}
      </h4>
      <p style={{ margin: "0 0 10px", fontSize: "calc(12px * var(--ui-font-scale-lg, 1))", color: "var(--text-muted)" }}>
        {t("proxy.description")}
      </p>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10, maxWidth: 520 }}>
        ...
        {candidates.length > 0 && (
          <div style={{ fontSize: "calc(11px * var(--ui-font-scale-sm, 1))", color: "var(--text-muted)", lineHeight: 1.6 }}>
        ...
        {effective && (
          <div style={{ fontSize: "calc(11px * var(--ui-font-scale-sm, 1))", color: "var(--status-success)", fontFamily: "var(--font-mono)" }}>
